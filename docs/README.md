...
- [**Project Overview: Studae — Offline-First Student Calendar with USOS Integration**](./overview.md): A high-level summary of the project's purpose, goals, and core components.
- [**System Architecture**](./architecture.md): A detailed explanation of the system architecture and the critical authentication flow.
- [**Agent Instructions**](./AGENT_INSTRUCTIONS.md): Central instructions for AI agents working in this repo.

### Components

- [**Mobile App (`app/`)**](./components/mobile_app.md): Documentation for the user-facing Flutter application.
- [**`usos_lib` Crate**](./components/usos_lib.md): Documentation for the shared Rust library for USOS API interaction.
- [**`usos_proxy_server`**](./components/usos_proxy_server.md): Documentation for the authentication proxy server.
